...
#Taken from https://github.com/NatTuck/hangman-2019-01/blob/02-06-multiplayer/rel/config.exs
get_secret = fn name ->
...
release :battleships do
  set version: current_version(:battleships)
  set applications: [
    :runtime_tools
  ]
end
