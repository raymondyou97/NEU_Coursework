...
public class ServiceAnswer {
    ...
    public ServiceAnswer(Boolean trueFalseAnswer, Integer minRangeAnswer, Integer maxRangeAnswer, Integer choiceAnswer,
            ServiceQuestion serviceQuestion, User provider) {
